...
/* find验证 */
 var whereJson = {
 'and' : [{'key':'main_status', 'opts':'!=', 'value' : '1'}]
 };
 var fieldsArr = ['main_url'];
 var orderByJson = {'key':'main_id', 'type':'asc'};
 //var limitArr = [0, 10];
 baseModel.find(tableName, whereJson, orderByJson,'',fieldsArr, function(ret){
 for(var main_url in ret){
	 console.log(ret);
 }
 });
